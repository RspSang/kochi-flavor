...
export default function Search({ ...rest }: SearchProps) {
  return (
    <div className="flex item-center relative w-full max-w-xl mt-7 px-8">
      <div className="pointer-events-none absolute left-0 flex items-center justify-center pl-[3.2rem] pt-[0.6rem]">
        <svg
